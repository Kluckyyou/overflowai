...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/overflowai")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "overflowai")
	...
	viper.SetDefault("database.dbname", "overflowai")
	...
	viper.SetDefault("pricing.remote_url", "https://raw.githubusercontent.com/Kluckyyou/model-price-repo/main/model_prices_and_context_window.json")
	viper.SetDefault("pricing.hash_url", "https://raw.githubusercontent.com/Kluckyyou/model-price-repo/main/model_prices_and_context_window.sha256")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "overflowai:")
...
func GetServerAddress() string {
	...
	v.AddConfigPath("/etc/overflowai")
