...
import (
	...
	adminhandler "github.com/Kluckyyou/overflowai/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "OverflowAI",
					...
					service.SettingKeySiteName:     "OverflowAI",
