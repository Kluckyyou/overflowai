...
| 项目 | 说明 |
|------|------|
| **上游仓库** | Kluckyyou/overflowai |
| **Fork 仓库** | bayma888/overflowai-bmai |
...
| 数据库凭据 | user=`overflowai`, password=`overflowai`, dbname=`overflowai` |
...
psql -U overflowai -h 127.0.0.1 -d overflowai -f temp.sql
```
...
3. 无密码登录并重置
   ...
   ALTER USER overflowai WITH PASSWORD 'overflowai';
...
```bash
# 连接数据库
psql -U overflowai -h 127.0.0.1 -d overflowai
...
# 执行 SQL 文件
psql -U overflowai -h 127.0.0.1 -d overflowai -f migration.sql
```
...
- [上游仓库](https://github.com/Kluckyyou/overflowai)
